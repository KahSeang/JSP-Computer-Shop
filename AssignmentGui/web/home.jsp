...
<html lang="en">
    ...
    <body>
        ...
        <section class="scrollable-section">
            <h1 class="section-title" style="text-align:center;">Hot Deal Items</h1>
            <div class="scrollable-container">
                ...
                <div class="scrollable-card">
                    <img src="sources/images/products/lp_4_a.png" alt="Card 2">
                    <h2>Ultra-Portable Laptops</h2>
                    <p>Lightweight laptops for on-the-go professionals.</p>
                </div>
                <div class="scrollable-card">
                    <img src="sources/images/products/lp_4_a.png" alt="Card 3">
                    <h2>Gaming Accessories</h2>
                    <p>Enhance your gaming experience with our accessories.</p>
                </div>
                <div class="scrollable-card">
                    <img src="sources/images/products/lp_4_a.png" alt="Card 4">
